...
List<String> leTextos() {
  ...
  while (true) {
    ...
    while (true) {
      print(
          "Digite -1 para terminar o texto $cont, pressione enter quando travar a linha");
      String texto = stdin.readLineSync(encoding: utf8) ?? '0';
      if (texto == '-1') {
        break;
      }
      if (texto == '0') {
...
void main() {
  ...
  //Habilitar entrada através do usuário
  ...
  int resultado = avaliaTextos(textos, parametros);
